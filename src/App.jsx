    ...
    <div className="min-h-screen font-serif text-ink bg-[#f2efe9] overflow-hidden relative flex flex-col items-center justify-center">
      ...
      <AnimatePresence mode="wait">
        ...
        {envelopePhase !== 'done' ? (
          ...
          >
            <div className="relative w-[340px] h-[240px] cursor-pointer group scale-90 md:scale-100" onClick={openEnvelope}>
               ...
               {/* Skrzydełka dolne i boczne */}
               <div className="absolute inset-0 pointer-events-none z-10">
                  <div className="absolute left-0 top-0 w-[172px] h-[240px] bg-[#e1d3c3]" style={{ clipPath: 'polygon(0 0, 100% 50%, 0 100%)' }}></div>
                  <div className="absolute right-0 top-0 w-[172px] h-[240px] bg-[#e1d3c3]" style={{ clipPath: 'polygon(100% 0, 0 50%, 100% 100%)' }}></div>
                  <div className="absolute bottom-0 left-0 w-full h-[142px] bg-[#e6d8c9]" style={{ clipPath: 'polygon(0 100%, 50% 0, 100% 100%)' }}></div>
               </div>

               {/* Skrzydełko górne z lakiem */}
               <motion.div 
                 className="absolute top-0 left-0 w-full h-[155px] origin-top z-20"
                 initial={{ rotateX: 0 }}
               ...
               <motion.div 
                  className="absolute -bottom-20 w-full text-center text-[10px] md:text-xs font-sans tracking-[0.2em] text-gray-500 uppercase"
